  ...
  <el-container>
    ...
    <el-container>
      <el-aside  :style="{width:isCollapse?'auto':'240px'}">
        ...
        <el-menu :collapse-transition="false" :router="true" :default-active="$route.path" class="el-menu-vertical-demo" :collapse="isCollapse">
          <el-submenu index="1">
            <template slot="title">
          ...
          <el-submenu index="2">
            ...
            <el-menu-item index="/shopType">店铺类别管理</el-menu-item>
          ...
          <el-submenu index="3">
            ...
            <el-menu-item index="/goodsType">商品类别管理</el-menu-item>
            <!--商品管理没有写-->
